...
class Log {
    ...
    public function logInvoice($order) {
        try {
            $this->_logger->addInfo("Order ".$order->getId()." parameters relevant to invoicing failure:");
            $this->_logger->addInfo("Order state: ".$order->getState());
            $this->_logger->addInfo("Order status: ".$order->getStatus());
            $this->_logger->addInfo("UNHOLD action flag: ".$order->getActionFlag(\Magento\Sales\Model\Order::ACTION_FLAG_UNHOLD));
            $this->_logger->addInfo("INVOICE action flag: ".$order->getActionFlag(\Magento\Sales\Model\Order::ACTION_FLAG_INVOICE));
